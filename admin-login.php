        ...
        <div class="row bg-white px-3 py-5 w-50 signin-outer">
            ...
            <div class="col-md-6 px-2">
                ...
                <form action="" method="POST" class="mt-3 d-flex flex-column align-items-start" autocomplete="off">
                    ...
                    <input type="submit" name="login" value="Login" class="btn btn-primary w-100 mt-2">
                </form>
                <div class="w-100 text-center mt-3">
                    <a href="index.php" class="link-secondary" class="text-align-center"><i class="fi fi-rr-users-alt mx-2"></i>Open Student Panel</a>
                </div>
            </div>
        </div>
    </main>
