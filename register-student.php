...
if(isset($_POST['register'])){
    ...
    else
    {
        ...
        {
            $sql="insert into students(student_name,student_email,student_password,profile_picture,admission_date) values('$student_email','$student_name','$student_password','$newfilename','$admission_date')";
